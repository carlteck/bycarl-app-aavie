...
export const PROCEDURES: Procedure[] = [
  {
    ...
    summary:
      'Première demande ou renouvellement de votre carte nationale d’identité.',
    ...
    documents: [
      ...
      {
        id: 'ancienne-piece',
        label: "Ancienne carte d'identité ou passeport (si renouvellement)",
      },
      {
        id: 'acte-naissance',
        label: 'Acte de naissance (si première demande)',
      },
    ],
    fields: [
      {
        ...
        type: 'select',
        options: ['Mme', 'M.'],
        prefillFromProfile: 'civilite',
      },
      {
        key: 'nom',
        label: 'Nom de naissance',
        type: 'text',
        prefillFromProfile: 'nom',
        required: true,
      },
      {
        key: 'prenom',
      ...
      },
      {
        ...
        type: 'date',
        prefillFromProfile: 'dateNaissance',
        required: true,
      },
      {
        key: 'lieuNaissance',
        ...
        type: 'text',
        prefillFromProfile: 'lieuNaissance',
      },
      {
        key: 'adresse',
        label: 'Adresse',
        type: 'text',
        prefillFromProfile: 'adresse',
        required: true,
      },
      {
        key: 'ville',
  ...
  },
  {
    ...
    summary:
      'Demande de passeport biométrique, en vue d’un voyage à l’étranger.',
    durationEstimate: '~15 min',
    online: true,
  ...
  },
  {
    ...
    category: 'Logement',
    summary:
      'Déclarez votre nouvelle adresse aux organismes (impôts, CAF, carte grise...) en une fois.',
    ...
    documents: [
      {
        id: 'justificatif-domicile',
        label: 'Nouveau justificatif de domicile',
      },
    ],
    fields: [
      {
  ...
  },
  {
    ...
    summary:
      'Demande de RSA pour les personnes sans ressources ou à faibles revenus.',
    ...
    documents: [
      ...
      {
        id: 'ressources',
        label: 'Justificatifs de ressources des 3 derniers mois',
      },
    ],
    fields: [
      {
  ...
  },
  {
    ...
    summary:
      'Demande d’aide au logement auprès de la CAF, en location ou en accession.',
    durationEstimate: '~15 min',
    online: true,
    icon: 'key-outline',
    documents: [
  ...
  },
  {
    ...
    category: 'Emploi',
    summary:
      'Inscription à France Travail (ex Pôle emploi) pour rechercher un emploi et être indemnisé.',
    durationEstimate: '~20 min',
    online: true,
    ...
    documents: [
      ...
      { id: 'cv', label: 'Curriculum vitae' },
      {
        ...
        label: 'Attestation employeur (dernier emploi)',
      },
    ],
    fields: [
      {
  ...
  },
  {
    ...
    summary:
      'Immatriculation d’un véhicule neuf, d’occasion, ou changement de titulaire.',
    durationEstimate: '~15 min',
    online: true,
    icon: 'car-outline',
    documents: [
      ...
      { id: 'justificatif-domicile', label: 'Justificatif de domicile' },
      {
        ...
        label: 'Certificat de cession (si occasion)',
      },
    ...
    fields: [
      ...
      {
        key: 'immatriculationActuelle',
        label: 'Numéro d’immatriculation actuel',
        type: 'text',
      },
      {
        key: 'marqueModele',
  ...
  },
  {
    ...
    summary:
      'Demande de titre pour un premier permis, un renouvellement ou un duplicata.',
    durationEstimate: '~15 min',
    online: true,
    ...
    documents: [
      ...
      {
        id: 'ancien-permis',
        label: 'Ancien permis (renouvellement ou duplicata)',
      },
    ],
    fields: [
      {
  ...
  },
  {
    ...
    summary:
      'Déclaration annuelle des revenus auprès de la Direction générale des finances publiques.',
    ...
    documents: [
      ...
      {
        id: 'justificatifs-revenus',
        label: 'Justificatifs de revenus (salaires, aides, pensions)',
      },
      { id: 'rib', label: 'Relevé d’identité bancaire (RIB)' },
    ],
    fields: [
  ...
  },
  {
    ...
    summary:
      'Première demande de carte Vitale ou mise à jour de vos droits à l’Assurance Maladie.',
    durationEstimate: '~10 min',
    online: true,
    icon: 'medkit-outline',
    documents: [
  ...
  },
  {
    ...
    summary:
      'Déclaration conjointe de PACS auprès de la mairie ou d’un notaire.',
    durationEstimate: '~15 min',
    online: false,
    icon: 'people-outline',
    documents: [
      ...
      {
        id: 'attestation-non-pacse',
        label: 'Attestations sur l’honneur de non-parenté et de résidence',
      },
    ],
    fields: [
      {
      ...
      {
        key: 'nomPartenaire',
        label: 'Nom du/de la partenaire',
        type: 'text',
        required: true,
      },
      {
        key: 'prenomPartenaire',
      ...
      {
        key: 'adresseCommune',
        label: 'Adresse commune envisagée',
        type: 'text',
        prefillFromProfile: 'adresse',
      },
    ],
  },
  {
    ...
    category: 'Étranger',
    summary:
      'Première demande ou renouvellement de titre de séjour pour les ressortissants étrangers.',
    durationEstimate: '~25 min',
    online: true,
    icon: 'earth-outline',
    documents: [
